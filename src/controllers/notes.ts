...
notesRouter.post('/', async (req: Request, res: Response, next: any) => {
    const {
      content,
      important = false
    } = req.body
...
notesRouter.put('/:id', async (req: Request, res: Response, next: any) => {
    const { id } = req.params
    const note = req.body
...
notesRouter.delete('/:id', async (req: Request, res: Response, next: any) => {
    const { id } = req.params
